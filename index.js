...
// ANSWER: LOOKED AT THE FOR LOOPS AND THE DATA THAT WAS INSTANCIATED
...
// ANSWER: I think it will be less significant that the last example but still faster.
...
console.log(myRoot.noCacheCalcRoot(8))
console.log(myRoot.noCacheCalcRoot(8))
console.log(myRoot.noCacheCalcRoot(8))
console.log(myRoot.noCacheCalcRoot(8))
